...
const DynamicMetaTags: React.FC = () => {
  ...
  useEffect(() => {
    ...
    > = {
      "/": {
        title: "SummitsTracker - Track Your Mountain Peaks | Summitstracker.com",
        description:
      ...
      "/help": {
        ...
        keywords: "summitstracker help, support, FAQ, user guide, climbing app help",
      },
      "/terms-of-service": {
        ...
        keywords: "terms of service, terms and conditions, summitstracker terms",
      },
    };
