...
import styles from "./ShelterNearbyShelters.module.css";
  ...
  return (
    <ShimmerWrapper isLoading={loading} hasData={hasData}>
      <section className={styles["nearby-shelters"]}>
        <div className={styles["nearby-shelters__header-wrapper"]}>
          <h3
            className={`${styles["nearby-shelters__title"]} typography-title-medium`}
          >
        ...
        {nearbyShelters.length > 0 ? (
          <div className={styles["nearby-shelters__scroll"]}>
            {nearbyShelters.map((shelter) => {
              ...
              return (
                ...
                >
                  <div
                    className={styles["nearby-shelters__card-overlay-top"]}
                  />
                  {!hasImage && (
                    <ShelterIcon
                      size={60}
                  ...
                  <div className={styles["nearby-shelters__card-content"]}>
                    <div
                      className={`${styles["nearby-shelters__card-name"]} typography-title-medium`}
                    >
                    ...
                    {shelter.elevation && (
                      <div
                        className={
                          styles["nearby-shelters__card-elevation-row"]
                        }
                      >
                        <span
                          className={`${styles["nearby-shelters__card-elevation-value"]} typography-title-small`}
                        >
                    ...
                    <div
                      className={styles["nearby-shelters__card-distance-row"]}
                    >
                      <span
                        className={
                          styles["nearby-shelters__card-distance-icon"]
                        }
                      >
                        <Navigation size={14} />
                      </span>
                      <span
                        className={`${styles["nearby-shelters__card-distance-value"]} typography-body-small`}
                      >
          ...
          <div
            className={`${styles["nearby-shelters__no-data"]} typography-body-medium`}
          >
