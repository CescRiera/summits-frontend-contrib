...
import styles from "./ShelterDescription.module.css";
import {
      ...
      <section className={styles["description__container"]}>
          ...
          {text ? (
            <div className={styles["description__content-overlay"]}>
              ...
              >
                <div ref={innerRef}>
                  <p
                    className={`${styles["description__text"]} typography-body-medium`}
                  >
                    {text}
                  </p>
                </div>
        ...
        {hasInfoData && (
          <div className={styles["description__info"]}>
            <p
              className={`${styles["description__info-text"]} typography-body-medium`}
            >
              {paragraphs.map((p, i) => (
            ...
            {websiteUrl && (
              <a
                ...
                className={`${styles["description__website-btn"]} typography-button-medium`}
              >
