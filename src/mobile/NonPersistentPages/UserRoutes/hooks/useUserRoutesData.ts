...
import { ROUTES_PER_PAGE } from "../types";
...
export const useUserRoutesData = (
  ...
  // Memoize filter key for stable comparison
  ...
  useEffect(() => {
    ...
    fetchRoutes(1, true);
  }, [user, userId, filterKey, sortKey, fetchRoutes]);
