  ...
  return (
    ...
    >
        ...
        <div className={styles["delete-popup__header"]}>
          <h2
            className={`${styles["delete-popup__title"]} typography-title-medium`}
          >
            {t("profile.deleteAccount")}
          </h2>
          <p
            className={`${styles["delete-popup__message"]} typography-body-medium`}
          >
        ...
        <div className={styles["delete-popup__actions"]}>
          <button
            className={`${styles["delete-popup__button"]} ${styles["delete-popup__button--cancel"]} typography-button-medium`}
            onClick={onClose}
            disabled={isLoading}
          >
            {t("common.cancel")}
          ...
          <button
            className={`${styles["delete-popup__button"]} ${styles["delete-popup__button--confirm"]} typography-button-medium`}
