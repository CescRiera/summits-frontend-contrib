...
import styles from "./desktop-EditChallengesModal.module.css";

type CreatedChallenge = UserStatsResponse["peaks_per_list"][number];

interface DesktopEditChallengesModalProps {
  isOpen: boolean;
  onClose: () => void;
  challenges: CreatedChallenge[];
}

const DesktopEditChallengesModal: React.FC<DesktopEditChallengesModalProps> = ({
  isOpen,
  onClose,
  challenges,
}) => {
            ...
            {challenges.map((challenge) => (
              ...
              >
                ...
                <div className={styles["edit-challenges-modal__item-text"]}>
                  <div
                    className={`${styles["edit-challenges-modal__item-title"]} typography-desktop-body-medium`}
                  >
                    {challenge.list_name}
                  </div>
                  <div
                    className={`${styles["edit-challenges-modal__item-subtitle"]} typography-desktop-body-small`}
                  >
...
export default DesktopEditChallengesModal;
