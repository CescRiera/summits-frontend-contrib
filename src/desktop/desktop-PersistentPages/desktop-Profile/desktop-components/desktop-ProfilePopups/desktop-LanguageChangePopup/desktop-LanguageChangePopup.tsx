...
import styles from "./desktop-LanguageChangePopup.module.css";
      ...
      <div>
        <div className={styles["language-popup__header"]}>
          <div className={styles["language-popup__header-text"]}>
            <h2
              className={`${styles["language-popup__title"]} typography-desktop-body-small`}
            >
              {t("profile.changeLanguage")}
            </h2>
            <p
              className={`${styles["language-popup__message"]} typography-desktop-body-small`}
            >
          ...
          {APP_LANGUAGE_OPTIONS.map((language) => (
            ...
            >
              <div className={styles["language-popup__item-info"]}>
                ...
                />
                <p
                  className={`${styles["language-popup__item-name"]} typography-desktop-body-small`}
                >
                  {language.nativeName}
                </p>
              </div>
        ...
        <div className={styles["language-popup__actions"]}>
          <button
            className={`${styles["language-popup__button"]} ${styles["language-popup__button--cancel"]} typography-desktop-button-medium`}
            onClick={onClose}
            disabled={isLoading}
          >
            {t("common.cancel")}
          ...
          <button
            className={`${styles["language-popup__button"]} ${styles["language-popup__button--confirm"]} typography-desktop-button-medium`}
