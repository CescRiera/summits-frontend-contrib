...
import styles from "./desktop-SuggestionsPopup.module.css";
      ...
      <div>
        <div className={styles["suggestions-popup__header"]}>
          <div className={styles["suggestions-popup__header-text"]}>
            <h2
              className={`${styles["suggestions-popup__title"]} typography-desktop-body-small`}
            >
        ...
        {showSuccess ? (
          <div className={styles["suggestions-popup__success"]}>
            <div
              className={`${styles["suggestions-popup__success-message"]} typography-desktop-body-small`}
            >
          ...
          >
            <div className={styles["suggestions-popup__field"]}>
              <label
                className={`${styles["suggestions-popup__label"]} typography-desktop-label-medium`}
              >
            ...
            <div className={styles["suggestions-popup__actions"]}>
              <button
                type="button"
                className={`${styles["suggestions-popup__button"]} ${styles["suggestions-popup__button--cancel"]} typography-desktop-button-medium`}
              ...
              <button
                type="submit"
                className={`${styles["suggestions-popup__button"]} ${styles["suggestions-popup__button--submit"]} typography-desktop-button-medium`}
