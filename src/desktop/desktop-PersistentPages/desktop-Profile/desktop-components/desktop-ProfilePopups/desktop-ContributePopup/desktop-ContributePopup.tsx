...
import styles from "./desktop-ContributePopup.module.css";
  ...
  return (
    ...
    >
      <div className={styles["contribute-popup__header"]}>
        <h2
          className={`${styles["contribute-popup__title"]} typography-desktop-title-large`}
        >
      ...
      <div className={styles["contribute-popup__body"]}>
        <p className={`${styles["contribute-popup__intro"]} typography-desktop-body-small`}>
        ...
        <ul className={styles["contribute-popup__options"]}>
          <li className={styles["contribute-popup__option"]}>
            <div className={styles["contribute-popup__option-body"]}>
              <span
                className={`${styles["contribute-popup__option-title"]} typography-desktop-label-medium`}
              >
                {t("profile.contributeCollaboratorsTitle")}
              </span>
              <p className={`${styles["contribute-popup__option-text"]} typography-desktop-body-small`}>
        ...
        <div className={styles["contribute-popup__donate-card"]}>
          <div className={styles["contribute-popup__donate-text"]}>
            <span
              className={`${styles["contribute-popup__donate-title"]} typography-desktop-label-medium`}
            >
              {t("profile.contributeDonateTitle")}
            </span>
            <p className={`${styles["contribute-popup__donate-description"]} typography-desktop-body-small`}>
          ...
          <div className={styles["contribute-popup__donate-row"]}>
            <div className={styles["contribute-popup__donate-field"]}>
              <input
                ...
                className={`${styles["contribute-popup__donate-input"]} typography-desktop-body-medium`}
                placeholder="0,00"
            ...
            <button
              type="button"
              className={`${styles["contribute-popup__donate-button"]} typography-desktop-button-medium`}
        ...
        {showSuccess ? (
          ...
          >
            ...
            <button
              type="submit"
              className={`${styles["contribute-popup__contact-button"]} typography-desktop-button-medium`}
