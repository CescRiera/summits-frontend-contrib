...
import styles from "./desktop-Weather.module.css";
...
const Weather: React.FC<WeatherProps> = ({ peakId }) => {
  ...
  usePeakDetailsView("desktop", "weather", hasData, peakId);
  ...
  return (
    <ShimmerWrapper isLoading={loading} hasData={hasData}>
      <section className={styles["weather"]}>
        ...
        {today && todayWeatherIcon && (
          <div className={styles["weather__current"]}>
            ...
            <button
              ...
              onClick={() => openHourlyModal(today.date, "today")}
            >
              <span className="typography-desktop-label-medium">
        ...
        {/* Individual forecast cards in vertical column */}
            ...
            {weather.daily_forecast.slice(1).map((day, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Temperature and precipitation % on right */}
