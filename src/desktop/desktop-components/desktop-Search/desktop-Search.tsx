            ...
            <div className={styles["search-dropdown__shimmer"]}>
              <div className={styles["search-dropdown__shimmer-item"]}>
                ...
                <div className={styles["search-dropdown__shimmer-text"]}>
                  <div
                    className={`${styles["search-dropdown__shimmer-title"]} typography-desktop-body-small`}
                  />
                  <div
                    className={`${styles["search-dropdown__shimmer-subtitle"]} typography-desktop-body-small`}
                  />
                </div>
              </div>
              <div className={styles["search-dropdown__shimmer-item"]}>
                    ...
                    <div className={styles["search-result-content"]}>
                      <div className={styles["search-result-image"]}>
                        {hasImage ? (
                          <img
                            src={
                              removeImageSizeRestriction(peakResult.image) || ""
                            }
                            alt={result.name}
                      ...
                      <div className={styles["search-result-info"]}>
                        <div
                          className={`${styles["search-result-title"]} typography-desktop-body-small`}
                        >
                        ...
                        <div className={styles["search-result-details"]}>
                          ...
                          />
                          <span
                            className={`${styles["search-result-elevation"]} typography-desktop-label-medium`}
                          >
                            {formatMeters(peakResult.elevation)}
                          </span>
                          {getLocationFromHierarchy(peakResult.admin_hierarchy) && (
                            <span
                              className={`${styles["search-result-location"]} typography-desktop-label-medium`}
                            >
                              {getLocationFromHierarchy(peakResult.admin_hierarchy)}
                            </span>
                          )}
                ...
                return (
                  ...
                  >
                    <div className={styles["search-result-content"]}>
                      ...
                      <div className={styles["search-result-info"]}>
                        <div
                          className={`${styles["search-result-title"]} typography-desktop-title-medium`}
                        >
                          {result.name}
                        </div>
                        <div className={styles["search-result-details"]}>
                          ...
                          <span
                            className={`${styles["search-result-elevation"]} typography-desktop-body-small`}
                          >
              ...
              {recentSearches.length === 0 ? (
                <div className={styles["search-initial-content"]}>
                  <div className={styles["search-initial-header"]}>
                    ...
                    />
                    <span
                      className={`${styles["search-initial-title"]} typography-desktop-body-small`}
                    >
                      {t("search.searchPeaksAndUsers")}
                    </span>
                  </div>
                  <p
                    className={`${styles["search-initial-description"]} typography-desktop-label-medium`}
                  >
