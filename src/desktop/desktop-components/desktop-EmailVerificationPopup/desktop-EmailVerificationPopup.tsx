...
import styles from "./desktop-EmailVerificationPopup.module.css";
  ...
  return (
    ...
    >
        ...
        <div className={styles["email-verification-popup__content"]}>
          ...
          <h3
            className={`${styles["email-verification-popup__title"]} typography-desktop-title-medium`}
          >
            {t("auth.emailVerification.title")}
          </h3>
          <p
            className={`${styles["email-verification-popup__message"]} typography-desktop-body-medium`}
          >
            {t("auth.emailVerification.message")}
          </p>
          <button
            className={`${styles["email-verification-popup__button"]} typography-desktop-button-medium`}
            onClick={onOpenGmail}
          >
